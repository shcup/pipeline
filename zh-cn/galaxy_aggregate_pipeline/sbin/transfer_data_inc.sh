...
scp ${IMAGETEXT_PIPELINE_DATA_DIR}/output/detail_builder/output_media_doc_info rec@$ip:~/data/recommendation/galaxy/engine/dynamic_data/media_doc_info_hourly_inc.sst
done
