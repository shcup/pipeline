...
#
# File:
# pipeline/indian_imagetext_pipeline_deploy/indian_imagetext_initial_pipeline/sbin/build_project.sh
...
COMMON_DATA_FILES="                                                                             \
        ...
        bin:${PIPELINE_HOME}/deploy/bin/mr_indian_imagetext_initial_pipeline                            \
...
COMMON_DATA_FILES="                                                                             \
        bin:../bin/mr_crawl_log_convert_main                                        \
        bin:../bin/crawl_document_converter_main                        \
        bin:../bin/mr_indian_handler_main
        bin:../bin/fresh.sh                                                 \
        jar:                                                            \
        sbin:../sbin/mr_indian_imagetext_initial_pipeline.sh                            \
        sbin:../sbin/mr_indian_imagetext_initial_pipeline_inc.sh               \
        sbin:../sbin/inc_pipeline_run.sh                                       \
        ...
        lib/model:../lib/model/business_dic.key                             \
        lib/model:../lib/model/business_tms.mode                                \
        lib/model:../lib/model/india_dic.key                                    \
        lib/model:../lib/model/india_tms.model                                  \
        lib/model:../lib/model/showbiz_dic.key                                  \
        lib/model:../lib/model/showbiz_tms.model                                \
        lib/model:../lib/model/sports_dic.key                                   \
        lib/model:../lib/model/sports_tms.model                                 \
        lib/model:../lib/model/tech_dic.key                                     \
        lib/model:../lib/model/tech_tms.model                                   \
        lib/model:../lib/model/world_dic.key                                    \
        lib/model:../lib/model/world_tms.model                                  \
        lib/java:../lib/java/custom_format_1_1_2.jar                           \
        conf:../conf/mr_imagetext_pipeline.conf                           \
        conf:../conf/normalized_category.conf \
        conf:../conf/normalized_crumbs.conf \
        conf:../conf/normalized_inlink.conf \
        conf:../conf/normalized_url_prefix.conf \
        log:                                                                                    \
        repo:                                                                                   \
        "
